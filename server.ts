          ...
          <div class="bg-white rounded-[28px] shadow-[0_4px_30px_rgba(0,0,0,0.06)] w-full max-w-[440px] p-8 sm:p-10 relative overflow-hidden flex flex-col justify-between min-h-[520px]">
            <div>
              ...
              <div class="space-y-2 max-h-[220px] overflow-y-auto pr-1">
                <button 
                  onclick="dispatchGoogleLogin('Super Admin (vakrangee653)', 'vakrangee653@gmail.com')"
                ...
                >
                  <div class="w-8 h-8 rounded-full bg-indigo-600 text-white flex items-center justify-center font-bold text-xs shrink-0 overflow-hidden">
