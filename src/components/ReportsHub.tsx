...
export default function ReportsHub({ 
  ...
  useEffect(() => {
    const checkServiceMode = () => {
      ...
      setIsServiceFree(modes.reports === 'Free');
    };
      ...
      {(!isServiceFree && activePlan === 'Free') ? (
        <div className="config-card p-8 text-center flex flex-col items-center justify-center gap-5 border border-dashed border-amber-500/30 bg-gradient-to-b from-slate-900/10 to-slate-950/20 rounded-2xl min-h-[400px]">
          ...
          <div className="max-w-md">
            <h3 className="text-xl font-extrabold text-gray-900 dark:text-white">🔒 VIP Reports Access Required / वित्तीय विश्लेषक बंद है</h3>
            <p className="text-xs text-slate-400 leading-relaxed mt-2">
              एडवांस्ड VLE P&L प्रॉफिट एवं लॉस स्टेटमेंट और वित्तीय लेज़र डाउनलोड करने की क्षमता केवल हमारे **Basic** और **Premium Pro** ग्राहकों के लिए उपलब्ध है।
            </p>
            <p className="text-xs text-slate-400 leading-relaxed mt-1">
              आज ही रीचार्ज करें और बिना रुकावट अपने केंद्र की कमाई का हिसाब-किताब रखें।
            </p>
          </div>
          <button 
            type="button"
