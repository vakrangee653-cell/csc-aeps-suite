...
export default function AuthOverlay({ onLoginSuccess, onMockEmailTrigger }: AuthOverlayProps) {
      ...
      if (event.data?.type === 'GOOGLE_OAUTH_SUCCESS') {
        ...
        if (googleUser) {
          ...
          if (existing) {
            ...
            const signupSecurePin = (isSuperAdminEmail || isAdminEmail) ? '9999' : String(Math.floor(1000 + Math.random() * 9000));
            const newUser: User = {
              id: googleUser.id,
            ...
            onMockEmailTrigger(
              ...
              `प्रिय ${googleUser.name},\n\nSmartSpe CSC Suite में आपका स्वागत है। गूगल द्वारा सत्यापित कर आपका नया खाता सक्रिय किया गया है।\n\nलॉगिन विवरण:\nजीमेल आईडी: ${googleUser.email}\nआपका डिफ़ॉल्ट सिक्योर पिन: ${signupSecurePin}\n\nआप इस सुरक्षा पिन (${signupSecurePin}) का उपयोग कर सुरक्षा को बढ़ा सकते हैं और सीधे पासवर्ड क्षेत्र में दर्ज करके लॉग इन कर सकते हैं। यह जानकारी सुरक्षित रखें।\n\nसादर,\nSmartSpe Technical Core Support Group`,
              googleUser.email
            );
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      console.error("❌ Google Authorization API failed. Engaging authentic warning display in popup...", err);
      ...
      try {
        const fallbackHtml = `
          ...
          <head>
            ...
            <title>Google Authentication Setup Assistant</title>
            <script src="https://cdn.tailwindcss.com"></script>
          </head>
          <body class="bg-slate-50 min-h-screen flex items-center justify-center p-6 font-sans">
            <div class="bg-white border border-gray-150 rounded-[24px] p-6 max-w-sm w-full text-center shadow-lg">
              <span class="text-3xl">🔑</span>
              <h2 class="text-base font-bold text-gray-800 mt-3">Live Google SSO Setup Needed</h2>
              <p class="text-xs text-gray-500 mt-2 mb-5 leading-relaxed">
                Sandbox Simulator mode is disabled. To sign in with your real Gmail account, please configure your <strong>GOOGLE_CLIENT_ID</strong> and <strong>GOOGLE_CLIENT_SECRET</strong> keys inside AI Studio Secrets tab!
              </p>
              <button onclick="window.close()" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 rounded-xl text-xs transition-colors cursor-pointer">
                I Understand
              </button>
            </div>
          </body>
          ...
          <div id="auth-signup-view" className="space-y-5">
            ...
            <div className="text-center space-y-2 select-none font-sans">
              ...
              <h2 className="text-lg font-extrabold text-gray-800 flex items-center justify-center gap-1">
                <span>VLE नया डिजिटल स्व-पंजीकरण</span>
              </h2>
              <p className="text-[11px] text-gray-550 max-w-sm mx-auto leading-relaxed">
                सुरक्षा मानकों के अंतर्गत, सभी नए संचालकों का क्रेडेंशियल केवल <strong>Google / Gmail</strong> खाते द्वारा ही सत्यापित कर सक्रिय किया जा सकता है।
              </p>
            </div>

            <div className="bg-indigo-500/5 border border-indigo-500/10 p-4 rounded-2xl space-y-3 text-left font-sans text-xs">
              <div className="font-bold text-indigo-900 flex items-center gap-1.5">
                <ShieldCheck className="w-4 h-4 text-indigo-600" />
                <span>सुरक्षित पंजीकरण प्रक्रिया (Steps):</span>
              </div>
              <ol className="list-decimal list-inside space-y-1.5 text-gray-600 font-medium leading-relaxed">
                <li>नीचे दिए गए गूगल बटन द्वारा अपनी <strong>सक्रिय जीमेल आईडी (Gmail ID)</strong> से लॉगिन करें।</li>
                <li>जीमेल सत्यापन पूर्ण होने के बाद, आपका खाता सर्वर द्वारा तुरंत रजिस्टर कर दिया जाएगा।</li>
                <li>आपका स्पेशल <strong>४-डिजिट लॉगिन पिन (PIN Code)</strong> और पासवर्ड सीधे आपके उसी ईमेल एड्रेस पर संदेश (Mock Dispatch Alert) द्वारा भेज दिया जाएगा।</li>
                <li>इस पिन क्रेडेंशियल का उपयोग कर आप हमेशा लॉगिन कर सकते हैं।</li>
              </ol>
            </div>

            {/* Google Authentication Button representing signup */}
            <div className="flex flex-col items-center justify-center gap-3 pt-2">
              <button 
                type="button" 
                onClick={handleGoogleSignIn}
                className="flex items-center justify-center gap-2.5 border border-indigo-200 hover:border-indigo-400 hover:bg-indigo-50/50 bg-[#eef2ff] hover:bg-indigo-50 text-xs font-black text-indigo-900 px-6 py-3 rounded-full w-full transition-all cursor-pointer shadow-[0_2px_8px_rgba(79,70,229,0.08)] scale-100 hover:scale-[1.01] active:scale-95 font-sans"
              >
                ...
                <span>जीमेल खाते से तत्काल सुरक्षित पंजीकरण करें (Sign Up with Gmail)</span>
              </button>
            </div>
