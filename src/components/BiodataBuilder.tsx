...
export default function BiodataBuilder({ activePlan = 'Free', onNavigateToSubscriptions }: BiodataBuilderProps) {
  ...
  useEffect(() => {
    const checkServiceMode = () => {
      ...
      setIsServiceFree(modes.biodata === 'Free');
    };
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {(!isServiceFree && activePlan === 'Free') ? (
        <div className="config-card p-8 text-center flex flex-col items-center justify-center gap-5 border border-dashed border-blue-500/30 bg-gradient-to-b from-slate-900/10 to-slate-950/20 rounded-2xl min-h-[400px]">
          ...
          <div className="max-w-md">
            <h3 className="text-xl font-extrabold text-gray-900 dark:text-white">🔒 VIP Access Required / बायोडाटा टूल बंद है</h3>
            <p className="text-xs text-slate-400 leading-relaxed mt-2">
              प्राइवेट व प्रोफेशनल Marriage Biodata व Resume Builder शीट प्रिंटिंग टूल केवल हमारे **Basic** और **Premium Pro** एक्टिव सब्सक्राइबर्स के लिए उपलब्ध है।
            </p>
            <p className="text-xs text-slate-400 leading-relaxed mt-1">
              आज ही रीचार्ज कर बेहद आसान UPI पेमेंट्स द्वारा अपने केंद्र को एक्टिवेट करें।
            </p>
          </div>
          <button 
            type="button"
            onClick={onNavigateToSubscriptions}
            className="btn-primary bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-extrabold px-6 py-3 cursor-pointer"
          >
